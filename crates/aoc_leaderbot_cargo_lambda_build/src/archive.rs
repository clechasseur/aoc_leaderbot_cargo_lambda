...
use aoc_leaderbot_cargo_lambda_metadata::{
    cargo::{CargoMetadata, target_dir_from_metadata},
    fs::copy_and_replace,
};
use aoc_leaderbot_cargo_lambda_remote::aws_sdk_lambda::types::Architecture as CpuArchitecture;
...
mod test {
    ...
    use aoc_leaderbot_cargo_lambda_metadata::{cargo::load_metadata, fs::copy_without_replace};
    use rstest::rstest;
