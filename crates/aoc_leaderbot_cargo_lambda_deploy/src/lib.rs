use aoc_leaderbot_cargo_lambda_build::{
    BinaryArchive, BinaryData, create_binary_archive, zip_binary,
};
use aoc_leaderbot_cargo_lambda_interactive::progress::Progress;
use aoc_leaderbot_cargo_lambda_metadata::cargo::{
    CargoMetadata,
...
mod tests {
    ...
    use aoc_leaderbot_cargo_lambda_metadata::cargo::load_metadata;
